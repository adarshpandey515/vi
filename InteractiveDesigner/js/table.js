      ...
      return (
        (() => {
          ...
          const y = function (e) {
              ...
              var aTableDragPending = !1,
                isBasicTableBlock = function (t) {
                  if (!t || "function" != typeof t.get) return !1;
                  var n = t.get("id"),
                    r = t.get("content");
                  return (
                    "table-block" === n ||
                    !!(r && "object" == typeof r && "customTable" === r.type)
                  );
                },
                isInsidePageSystem = function (t) {
                  if (!t) return !1;
                  try {
                    for (var n = t; n; ) {
                      var r = n.getClasses ? n.getClasses() : [];
                      if (
                        r &&
                        r.indexOf &&
                        (r.indexOf("page-container") >= 0 ||
                          r.indexOf("main-content-area") >= 0)
                      )
                        return !0;
                      n = n.parent ? n.parent() : null;
                    }
                  } catch (e) {}
                  try {
                    var o = t.getEl && t.getEl();
                    return !!(
                      o &&
                      ((o.closest && o.closest(".page-container")) ||
                        (o.closest && o.closest(".main-content-area")))
                    );
                  } catch (e) {}
                  return !1;
                },
                isPlaceholderTable = function (t) {
                  if (!t || "customTable" !== t.get("type")) return !1;
                  try {
                    var n = t.components && t.components();
                    if (!n) return !1;
                    ...
                    if (
                      !r ||
                      "tr" !== String(r.get && r.get("tagName") || "").toLowerCase()
                    )
                      return !1;
                    var o = r.components && r.components();
                    if (!o || 1 !== o.length) return !1;
                    var i = o.at(0),
                      a = i && i.components ? i.components() : null;
                    if (!a || 0 === a.length) return !0;
                    if (1 === a.length) {
                      var s = a.at(0),
                        l = String((s && s.get && s.get("content")) || "").trim();
                      return !l;
                    }
                  } catch (e) {}
                  return !1;
                },
                clearPlaceholderTable = function (t) {
                  try {
                    var n = t.components && t.components();
                    n && n.reset && n.reset([]);
                  } catch (e) {}
                };
              e.on("block:drag:start", function (e) {
                aTableDragPending = isBasicTableBlock(e);
              }),
                e.on("block:drag:stop", function () {
                  setTimeout(function () {
                    aTableDragPending = !1;
                  }, 1200);
                }),
                e.on("component:add", function (t) {
                  if ("customTable" === (t.get ? t.get("type") : t.attributes.type)) {
                    var n = t.components && t.components(),
                      r = !!n && 0 == n.length;
                    !r &&
                      aTableDragPending &&
                      isInsidePageSystem(t) &&
                      isPlaceholderTable(t) &&
                      (clearPlaceholderTable(t), (r = !0)),
                      r &&
